...
We capture this intuition with the following.
...
We are ready to present a query-answering procedure based on the intuition of \Cref{remark-towards-query-answering-procedure}.
