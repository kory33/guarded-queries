...
The current implementation suffers from blowups, doubly exponential in the maximum arity of the input signature and exponential in the number of constants and predicates (\Cref{remark:rewriting-complexity}). Our system, therefore, cannot yet be applied to real-world ontologies, which typically contain many constants and predicates.
