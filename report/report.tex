...
\begin{figure}[ht]
  \centering
  \caption{The hypergraph corresponding to $Q$ in \Cref{query-connectedness}.}
  \includesvg{./diagrams/query-connectedness-example.drawio.svg}
\end{figure}

\begin{example}
\label{query-connectedness}
  ...
  $Q$-connected components of $\{z_1, z_2, z_4, z_5\}$ are $\{z_1,z_2,z_5\}$ and $\{z_4\}$. $Q$ is a connected Boolean query.
  \qed
\end{example}
...
% TODO: talk about test queries with GTGD-reducible hypergraph structures 
...
% TODO: talk about how we do not really need to solve subquery entailment problem for most queries (ones that are "GTGD-reducible"), and the possibility of exploiting the acyclicity in the middle of SE computation
