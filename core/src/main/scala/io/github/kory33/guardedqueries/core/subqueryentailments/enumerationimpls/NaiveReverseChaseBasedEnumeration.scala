...
import io.github.kory33.guardedqueries.core.datalog.{DatalogSaturationEngine, GuardedDatalogReverseChaseEngine}
...
import io.github.kory33.guardedqueries.core.formalinstance.joins.naturaljoinalgorithms.{FilterNestedLoopJoin, SingleAtomMatching}
...
import io.github.kory33.guardedqueries.core.subsumption.localinstance.{IndexlessMaximallyStrongLocalInstanceSet, MaximallyStrongLocalInstanceSet}
...
import io.github.kory33.guardedqueries.core.utils.FunctionSpaces.{allFunctionsBetween, allInjectionsBetween, allPartialFunctionsBetween}
 ...
 */
class NaiveReverseChaseBasedEnumeration(
  ...
  import NaiveReverseChaseBasedEnumeration.SubqueryRepresentation
  ...
  override def apply(_extensionalSignature: FunctionFreeSignature,
    ...
    for {
      subquery <- NaiveReverseChaseBasedEnumeration.allWellFormedSubqueryRepresentations(
        boundVariableConnectedQuery,
        saturatedRuleSet.constants.map(RuleConstant.apply),
        maxArityOfAllPredicatesInRuleQueryPair
      )
...
object NaiveReverseChaseBasedEnumeration {
